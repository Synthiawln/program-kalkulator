...
public class MyCalculator extends Frame
{
	...
	String operatorButtonText[] = {"/", "√", "x", "%", "-", "1/X", "+", "=" };
	String memoryButtonText[] = {"MC", "MR", "MS", "M+" };
	String specialButtonText[] = {"hapus", "C", "CE" };
...
//***class bagian dari digital button***//
class MyDigitButton extends Button implements ActionListener
{
	MyCalculator cl;
	//merepresentasikan tombol digit kalkulator//
...
//**bagian operator button**//
class MyOperatorButton extends Button implements ActionListener
{
	MyCalculator cl;
	//merepresentasikan tombol operator kalkulator//
...
//**bagian memory class kalkulator**//
class MyMemoryButton extends Button implements ActionListener
{
	MyCalculator cl;
	//merepresentasikan tombol memori kalkulator//
...
//**bagian spesial button**//
class MySpecialButton extends Button implements ActionListener
{
	MyCalculator cl;
	//merepresentasikan tomnol khusus pada kalkulator//
